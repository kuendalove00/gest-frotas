 ...
 * @author Love
 */
public class ListRota extends javax.swing.JFrame {

    /**
     * Creates new form ListRota
     */
    public ListRota() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Listagem de Rotas");
    ...
    private void btnLoadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadActionPerformed
        ...
        try {
            ...
            while(rs.next()){
                id = rs.getString(1);
                origem = rs.getString(2);
                destino = rs.getString(3);
                String[] row= {id, origem, destino};
                model.addRow(row);
            }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (dataTable.getSelectedRowCount() == 1) {
            ...
            try {
                ...
                st.execute(query);
                showMessageDialog(null, "Rota Removida!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListRota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
