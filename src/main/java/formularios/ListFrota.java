 ...
 * @author Love
 */
public class ListFrota extends javax.swing.JFrame {

    /**
     * Creates new form ListFrota
     */
    public ListFrota() {
        initComponents();
    }
    ...
    private void LoginBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginBtn1ActionPerformed
        ...
        try {
            ...
            String id, marca, modelo, categoria;
            while(rs.next()){
                id = rs.getString(1);
                marca = rs.getString(2);
                modelo = rs.getString(3);
                categoria = rs.getString(4);
                String[] row= {id,marca,modelo,categoria};
                model.addRow(row);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListFrota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
