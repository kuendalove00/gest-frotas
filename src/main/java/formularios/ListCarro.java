 ...
 * @author Love
 */
public class ListCarro extends javax.swing.JFrame {

    /**
     * Creates new form ListCarro
     */
    public ListCarro() {
        initComponents();
    }
    ...
    private void btnLoadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadActionPerformed
        ...
        try {
            ...
            String id,matricula, portas, combustivel, ac, transmissao,veiculo;
            while(rs.next()){
                id = rs.getString(1);
                matricula = rs.getString(2);
                portas = rs.getString(3);
                combustivel = rs.getString(4);
                ac = rs.getString(5);
                transmissao = rs.getString(6);
                veiculo = rs.getString(7);
                String[] row= {id,matricula, portas, combustivel, ac, transmissao,veiculo};
                model.addRow(row);
            }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (dataTable.getSelectedRowCount() == 1) {
            ...
            try {
                ...
                st.execute(query);
                showMessageDialog(null, "Carro Removido!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListCarro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
